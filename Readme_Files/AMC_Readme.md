<img width="2254" height="1080" alt="AMC GitHub Page Thumbnail" src="https://github.com/user-attachments/assets/0f78bb83-cda1-4a91-8d17-89baeb6879fb" />
...
- [Installation](#installation)
  ...
  - [Wabbajack Installation](#wabbajack-installation)
    ...
    - [Downloading and Installing Ad Mortem](#downloading-and-installing-ad-mortem)
...
Downloading and installing Ad Mortem can take a while depending on your internet connection, PC specs, and if you have Nexus Premium. Without Premium, you will need to manually click the **Slow Download** button for each mod.

To install Ad Mortem, complete the following steps.
 ...
 3. Press the download arrow on the Ad Mortem UI card and wait for it to download
 4. Set the `Installation Location` to a folder such as `C:\Ad Mortem`.
...
## Game Folder
Ad Mortem uses a Wabbajack feature called Stock Game to keep your Skyrim installation clean. All the files that you need to run the list are in a folder called `Stock Game`. You don’t need to copy anything at all.
...
## Before Launching the Game
 1. Head over to your modlist installation folder (e.g. `C:\Ad Mortem`), locate an executable named `ModOrganizer.exe`, and launch it. Your first launch of Mod Organizer 2 may take several minutes due to GitHub repository downloads, so please be patient.
...
Simply delete the Ad Mortem folder. Congratulations, you have uninstalled Ad Mortem.
