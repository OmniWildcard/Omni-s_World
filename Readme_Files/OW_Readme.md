...
- [Installation](#installation)
  ...
  - [Wabbajack Installation](#wabbajack-installation)
    ...
    - [Downloading and Installing Omni's World](#downloading-and-installing-omni's-world)
...
# Installation
Installing Omni's World is relatively easy and, if you have Nexus Premium, will be a simple waiting game. If you are updating the modlist, you can safely skip to the [updating section](#updating-the-modlist).
...
>[!WARNING]
>Larger Skyrim modlists require a significant amount of memory, running out of memory **will** result in crashes and other potential issues. Due to the list's size and number of files contained within, this step is **NOT** optional. I do not care how much RAM or VRAM you have, please do this step.
...
### Downloading and Installing Omni's World
>[!CAUTION]
...
Downloading and installing Omni's World can take a while depending on your internet connection, PC specs, and if you have Nexus Premium. Without Premium, you will need to manually click the **Slow Download** button for each mod.

To install Omni's World, complete the following steps.
 ...
 3. Press the download arrow on the Omni's World UI card and wait for it to download
 4. Set the `Installation Location` to a folder such as `C:\Omni's World`.
...
## Game Folder
Omni's World uses a Wabbajack feature called Stock Game to keep your Skyrim installation clean. All the files that you need to run the list are in a folder called `Stock Game`. You don’t need to copy anything at all.
...
<summary>Setting up Windows Defender Exceptions:</summary>
 ...
 9. **(OPTIONAL)** You can repeat these steps for the individual executables.
...
## Before Launching the Game
 1. Head over to your modlist installation folder (e.g. `C:\Omni's World`), locate an executable named `ModOrganizer.exe`, and launch it. Your first launch of Mod Organizer 2 may take several minutes due to GitHub repository downloads, so please be patient.
...
Simply delete the Omni's World folder. Congratulations, you have uninstalled Omni's World.
...
- **Question:** I added a mod to the list and now I'm getting constant CTD's. What do I do?
	- **Answer:** If you modified the list outside the specified areas of gameplay that were listed [here](https://github.com/OmniWildcard/Omni-s_World/tree/main#about-the-mod-lists) whether or not you are provided support will be subject to my discretion.
