...
- [Download v1.0.18.13](https://www.mediafire.com/file_premium/l2qo80se83rpy5i/Chaos_Mage_Randomized_Challenge.wabbajack/file) **[!] Latest Version**
...
5) Open the ImprovedCameraSE.json file located under <ins>*Modding > MO2 > mods > ImprovedCameraSE > skse > plugins > ImprovedCameraSE*</ins> and edit the 24th line. You'll want to change the phrase "Default" to "NoHeadbob" and save the changes.
