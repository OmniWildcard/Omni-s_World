...
1) Join the [Improved Camera Discord Server](https://discord.gg/improved-camera-se-1074109591966732328) and download the latest version of the v2.0 beta build from their updates channel. Install and place it under the Modular Extra section. This will ensure the included profile edits win the conflict.
