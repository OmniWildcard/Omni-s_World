...
2) Navigate to the Improved Camera SE settings folder for the beta build, which if you followed my instructions will be <ins>*MO2 > mods > Improved Camera SE > SKSE > Plugins > ImprovedCameraSE*</ins> and open the ImprovedCameraSE.json file in notepad. After that change line 24 from **"active": "Default"** to **"active": "Headbob"** and save your changes.
